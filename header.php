	...
	<div id="container"><!--container-->
        ...
        <ul class="nav">
			...
			foreach( $pages as $page ) {
				...
				<li style="float:right"><a style="padding:0;margin-right:7px;" href="http://feed.pureweber.com"><img style="border:none;" src="<?php bloginfo('template_url') ?>/images/rss.jpg" /></a></li>
        </ul>
        <div class="ffix"></div>
